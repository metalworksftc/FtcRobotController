...
@Autonomous(name = "Identify Cube 2 Blue")

public class IdentifyCube2Blue extends LinearOpMode {
    Wheels wheels;
    Intake intake;
    CameraCube camera;
    ...
    public void runOpMode() {
        ...
        if (cube == 1) {
            ...
            wheels.right(2, wheels.driveSpeed);
