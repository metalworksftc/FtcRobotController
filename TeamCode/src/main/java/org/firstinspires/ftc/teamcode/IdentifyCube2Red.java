...
public class IdentifyCube2Red extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (cube == 1) {
            ...
            intake.beaterBarUp();
            wheels.forwards(6.5, wheels.driveSpeed);
            ...
            wheels.absoluteTurnPower(90, wheels.driveSpeed);
            wheels.backwards(80, 0.65);

        } else if (cube == 2) {

            wheels.left(2.75, wheels.driveSpeed);
            wheels.forwards(16, .45);
            wheels.left(15, wheels.driveSpeed);
            wheels.absoluteTurnPower(180, wheels.driveSpeed);
            ...
            wheels.left(50, wheels.driveSpeed);
            intake.down(180,.75);
            wheels.backwards(20, wheels.driveSpeed);
            intake.beaterBarUp();
            wheels.forwards(6.5, wheels.driveSpeed);
            wheels.absoluteTurnPower(0, wheels.driveSpeed);
            intake.up(2250,0.75);
            ...
            intake.beaterBarOut();
            wheels.backwards(6.5, wheels.driveSpeed);
            wheels.absoluteTurnPower(0, wheels.driveSpeed);
            intake.up(2250,0.75);
            intake.beaterBarUp();
            //intake.down(1000,0.75);
